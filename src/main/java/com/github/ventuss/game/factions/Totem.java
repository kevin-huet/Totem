package com.github.ventuss.game.factions;
...
public class Totem implements IGame {
    ...
    private HashMap<Block, MPlayer> history = new HashMap<Block, MPlayer>();
    ...
    public void playerBreakTotemBlock(Player tmp) {
        MPlayer player = MPlayer.get(tmp);
    ...
    public void victory(Player player) {
        ...
        Manager.getInstance().configManager.sqlConfig.addWinner(faction.getName(), this.ptsForWin);
    }
    ...
    public void setHistory(HashMap<Block, MPlayer> history) {
        this.history = history;
    }

    public void addBreakHistory(Block block, MPlayer player) {
    ...
    public String getFactionName() {
        if (this.actualFaction == null)
            return null;
        return this.actualFaction.getName();
    }
}
